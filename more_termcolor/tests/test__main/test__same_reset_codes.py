...
def test__onblack_ongreen_onblack():
    ...
    actualprint(onblack_ongreen_onblack)
...
def test__boldbrightwhite__dark__boldbrightwhite():
    ...
    actualprint(boldbrightwhite__dark__boldbrightwhite)
...
def test__darkbold__brightwhite__darkbold():
    ...
    actualprint(darkbold__brightwhite__darkbold)
